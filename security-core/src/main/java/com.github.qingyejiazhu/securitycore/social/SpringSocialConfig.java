...
/*    @Bean
    ...
    public ProviderSignInUtils providerSignInUtils(ConnectionFactoryLocator connectionFactoryLocator,
        ...
        // 如果应用数据库中没有第三方用户关联 SocialAuthenticationProvider 抛出异常BadCredentialsException，SocialAuthenticationFilter 捕获异常catch (BadCredentialsException var5)，如果配置了跳转注册页 signupUrl，就在connection从token中拿出放入session中
