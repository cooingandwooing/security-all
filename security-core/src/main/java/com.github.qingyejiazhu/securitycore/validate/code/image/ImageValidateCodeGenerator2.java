...
import com.github.qingyejiazhu.securitycore.properties.ImageCodeProperties;
 ...
 * @since 1.0
 */
public class ImageValidateCodeGenerator2 implements ValidateCodeGenerator {
    private ImageCodeProperties imageProperties;

    public ImageValidateCodeGenerator2(ImageCodeProperties imageProperties) {
    ...
    public ImageCode createImageCode(HttpServletRequest request) throws IOException {
        // 先从请求中获取，然后从配置中获取
        // 如果配置中的没有被覆盖则是默认配置 imageProperties.getWidth() 就是默认的值
